...
class AtulyaContext:
    ...
    async def _process_chain(self, atulya: "Atulya", msg: "UserMessage|str", user=True):
        try:
            msg_template = (
                await atulya.hist_add_user_message(msg)  # type: ignore
                if user
                else await atulya.hist_add_tool_result(
            ...
            try:
                ...
                while True:
                    ...
                    try:
                        ...
                        self.set_data(Atulya.DATA_NAME_CTX_WINDOW, prompt.format())
                        ...
                        if (
                            ...
                            await self.hist_add_ai_response(atulya_response)
