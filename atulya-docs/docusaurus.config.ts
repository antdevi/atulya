...
const config: Config = {
  title: 'Atulya',
  tagline: 'A living algorithm for machine intelligence (MI)',
  ...
  url: 'https://atulya.eightengine.com',
  baseUrl: '/',

  organizationName: 'eight-atulya',
  projectName: 'atulya',
  trailingSlash: false,
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              href: 'https://join.slack.com/t/atulya-space/shared_invite/zt-3nhbm4w29-LeSJ5Ixi6j8PdiYOCPlOgg',
              label: 'Community',
            },
          ],
        },
        {
          href: 'https://ui.atulya.eightengine.com/signup',
          position: 'right',
          label: 'Cloud',
