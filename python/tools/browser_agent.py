    ...
    async def _run_task(self, task: str):
        ...
        class CustomSystemPrompt(browser_use.SystemPrompt):
            def important_rules(self) -> str:
                ...
                new_rules = atulya.read_prompt("prompts/browser_atulya.system.md")
...
class BrowserAtulya(Tool):
    ...
    async def prepare_state(self, reset=False):
        self.state = self.atulya.get_data("_browser_atulya_state")
        if not self.state or reset:
            self.state = await State.create(self.atulya)
        self.atulya.set_data("_browser_atulya_state", self.state)
